  ...
  const handlePointerEnter = (e) => {
    ...
    if (view === 'socials' && mesh.userData.cube) {
      ...
      tl.to(mesh.material.uniforms.uHovered, {
        ...
        ease: Power1.easeIn,
        value: 1.0,
      }).to(mesh.material.uniforms.uScale, {
        duration: 0.2,
        delay: -0.2,
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh
        ...
        userData={{ name: 'instagram', cube: true }}
      >
        <emissiveCubeMaterial
          uTime={timeElapsed + 0.25}
      ...
      <mesh
        ...
        userData={{ name: 'linkedIn', cube: true }}
      >
        <emissiveCubeMaterial
          uTime={timeElapsed + 0.5}
      ...
      <mesh
        ...
        userData={{ name: 'github', cube: true }}
      >
        <emissiveCubeMaterial
          uTime={timeElapsed + 0.75}
